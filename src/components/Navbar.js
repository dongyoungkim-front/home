...
function Navbar({changeColor}) {
  ...
  return (
    <div className="navbar shadow-2xl bg-primary text-primary-content " >
      ...
      <div className="flex-1">
        <Link to="/" className="btn btn-ghost normal-case text-xl">KB AI-OCR </Link>
        <div className="dropdown ">
          ...
          <ul tabIndex="0" className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
            ...
            <li key="team"><Link to="/team">Team</Link></li>
            <li key="launcher"><Link to="/launcher">Launcher</Link></li>
            <li key="viewer"><Link to="/viewer">Viewer</Link></li>
